...
def create_placement_groups(args):
    ...
    num_gpus = 0
    num_gpus = args.student_num_nodes * args.student_num_gpus_per_node + args.teacher_num_gpus
    teacher_offset = args.student_num_nodes * args.student_num_gpus_per_node

    print(f"Creating placement group with {num_gpus} GPUs...")
    pg, student_pg_reordered_bundle_indices = _create_placement_group(num_gpus)

    teacher_pg_reordered_bundle_indices = student_pg_reordered_bundle_indices[teacher_offset:]
